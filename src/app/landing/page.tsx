...
export default async function LandingPage({ searchParams }: PageProps) {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section - Responsive height and text */}
      <div className="relative h-[400px] sm:h-[500px] lg:h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center text-white px-4">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-3 sm:mb-4 tracking-tight">
            People&apos;s Voice
          </h1>
          <p className="text-lg sm:text-xl lg:text-2xl mb-6 sm:mb-8 font-light">
            Massachusetts&apos;s Community Voting & Policy Platform
          </p>

          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center max-w-2xl mx-auto">
            <Link
              href="/town-selection"
              className="w-full sm:w-64 bg-white text-blue-900 hover:bg-gray-100 px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold text-base sm:text-lg transition-colors shadow-lg"
            >
              Select Your Town
            </Link>
            <Link
              href="/trending"
              className="w-full sm:w-64 bg-blue-600 hover:bg-blue-700 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold text-base sm:text-lg transition-colors shadow-lg"
            >
              Trending Issues
            </Link>
          </div>
      ...
      {/* Issues from Your City Section - Mobile optimized grid */}
